...
ActiveRecord::Schema[8.0].define(version: 2026_08_14_064634) do
  ...
  create_table "apple_premium_subscriptions", force: :cascade do |t|
    ...
    t.boolean "auto_renews", default: true, null: false
    t.string "original_transaction_id"
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["user_id"], name: "index_apple_premium_subscriptions_on_user_id", unique: true
  end
  ...
  create_table "transactions", force: :cascade do |t|
    ...
    t.index ["user_id", "tracking_key"], name: "index_transactions_on_user_id_and_tracking_key", where: "(tracking_key IS NOT NULL)"
