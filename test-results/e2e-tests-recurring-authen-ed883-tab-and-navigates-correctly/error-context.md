...
- Name: e2e/tests/recurring.spec.ts >> authenticated user >> Transactions page shows 'Recurrentes' tab and navigates correctly
- Location: e2e/tests/recurring.spec.ts:36:7
...
Call log:
  - navigating to "/transactions", waiting until "load"
