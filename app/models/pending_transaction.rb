...
#  user_id              :integer         not null   no default           index: index_pending_transactions_on_duplicate_fields, index_pending_transactions_on_user_id
#  bank_account_id      :integer         not null   no default           index: index_pending_transactions_on_bank_account_id, index_pending_transactions_on_duplicate_fields
#  date                 :date            null       no default           index: index_pending_transactions_on_duplicate_fields
#  description          :text            null       no default           no index
#  amount               :decimal         null       no default           index: index_pending_transactions_on_duplicate_fields
...
#  index_pending_transactions_on_duplicate_fields (user_id, bank_account_id, date, amount) non-unique
