...
# Build assets for test environment if they don't exist
if Rails.env.test? && !File.exist?(Rails.root.join('app/assets/builds/application.css'))
...
RSpec.configure do |config|
  ...
  # /spec would pull in the same behaviour as `type: :model` but this
