...
class Savings::TransactionBackfiller < ApplicationService
  ...
  def call
    return nothing_to_do unless saving.auto_sync_transactions? && saving.status_active?
    return nothing_to_do if saving.category_ids.empty? || saving.bank_account_ids.empty?
