...
#  category_id          :integer         null       no default           index: index_savings_on_category_id
#  bank_account_id      :integer         null       no default           index: index_savings_on_bank_account_id
...
#
# Indexes:
#  index_savings_on_bank_account_id (bank_account_id) non-unique
#  index_savings_on_category_id   (category_id) non-unique
